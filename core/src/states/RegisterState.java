...
public class RegisterState extends State {
    ...
    protected RegisterState(GameStateManager gsm) {
        super(gsm);
    ...
    private void createCanvas(){
        ...
        txtPasswordCheck.setPosition(AlienDemo.WIDTH /2F - (txtPasswordCheck.getWidth()/2f), AlienDemo.HEIGHT/2F - (txtPasswordCheck.getHeight()/2f)+60);
        stage.addActor(txtPassword);
    }
